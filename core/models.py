...
class Field(models.Model):
    ...
    agent = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name="fields")
    ...
    def status(self):
        ...
        if self.current_stage == "planted" and (date.today() - self.planting_date) > timedelta(days=30):
            return "At Risk"
